  ...
  return (
    <section className="py-16 bg-gray-50 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
        ...
        <h2 className="text-lg font-semibold text-gray-700 mb-2">Everyday Elegance, Luxury Looks! </h2>
        <h2 className="text-4xl lg:text-5xl font-bold mb-6">Clothes that keep up with life</h2>
        <p className="text-lg text-gray-600 mb-6">
          Discover our exclusive collection of clothing that combines style and comfort for every occasion. 
